...
namespace RLTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(SetByCaller_PhysicalCoefficient, "SetByCaller.PhysicalCoefficient", "Attack-power coefficient for physical hits.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(SetByCaller_SpellCoefficient,    "SetByCaller.SpellCoefficient",    "Spell-power coefficient for spell hits.");
}
