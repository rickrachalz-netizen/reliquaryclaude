...
namespace RLTags
{
	...
	RELIQUARY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Essence);
	...
	RELIQUARY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Exposed);
	RELIQUARY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_MortalWounds);
	RELIQUARY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_BladestormEmpowered);
	RELIQUARY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_CrushedArmor);
	RELIQUARY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Demoralized);
	RELIQUARY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Parry);
	...
	RELIQUARY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Set_Duskheart);
